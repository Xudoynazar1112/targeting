...
const Section2 = () => {
  return (
    <div className="flex flex-col md:flex-row gap-10 mt-10">
      <div data-aos="fade-up" className="bg-slate-50 shadow-lg p-10 rounded-xl md:w-3/5 flex justify-between flex-col">
        <h1 className="rang uppercase w-60 font-bold md:text-5xl text-4xl">Men haqimda</h1>
